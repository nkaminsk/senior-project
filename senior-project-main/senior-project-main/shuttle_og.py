...
class crideWindow(Screen):
    ...
    def success(self, urlrequest, result):
        ...
        try:
            ...
            user = pd.DataFrame([[self.ride_token, self.prof_name, self.destination_name, self.location_name, "Coming Soon...", self.current_lat, self.current_lon, self.search_latitude, self.search_longitude, '0', '0', '0', '0', self.selected_time, self.my_token, self.ride_price]],
